...
<head>
	...
	<title>SI DUKAR</title>
	<link rel="icon" href="dist/img/sidukarr.png">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto ">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI DATA KEPENDUDUKAN DESA KALIANYAR</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-light-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/sidukarr.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> SI DUKAR</span>
			</a>
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://kalianyar-bjn.bjndesa.id/">
					<strong>Kalianyar</strong>
				</a>
				All rights reserved.
			</div>
			<b>Kang Fikri86</b>
